...
const Banner = () => {
  return (
    <div className='flex sm:flex-row flex-col-reverse justify-between my-5 items-center work-sans  md:mx-24 sm:mx-6 mx-3 px-27 py-10'>
      <div className='flex flex-col max-sm:items-center gap-10'>
        ...
        <Link to="/listview"><button className='px-5 py-3 max-w-40 rounded-lg bg-[#23BE0A] text-white'>View The List</button></Link>
      </div>
