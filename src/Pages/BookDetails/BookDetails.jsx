...
import { addToWishListed } from '../../Utility/WishListToLocalStorage';
    ...
    <div className='work-sans flex sm:flex-row flex-col gap-10 my-10  md:mx-24 sm:mx-6 mx-3 px-5'>
      ...
      <div>
        ...
        <div className='flex my-4 gap-5'>
          <button onClick={() => handleAddToLocalStorage(id)} className='btn'>Mark as Read <FaReadme />
          </button>
          <button onClick={() => handleAddToWishListStorage(id)} className='btn bg-[#50B1C9]'>Add to Wishlist <FaHeart />
          </button>
        </div>
